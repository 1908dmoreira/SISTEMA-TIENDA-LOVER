...
<html lang="en" dir="ltr">
  <head>
        ...
        <link rel="stylesheet" href="nivo-slider/css/mi-slider.css"> -->
  ...
  <body>
    ...
    <div class="inicio" id="inicio-datos">
              ...
              <div class="slider-carousel">
                <div class="slider">
                  ...
                  <div class="slide-panel">
                    <img class="slide-img" src="img/img-slider/foto1.jpg" alt="">
                    <div class="slide-box">
                      <h2 class="slide-text">Bienvenidos a</h2>
                    </div>
                    <div class="slide-overlay"></div>
                  </div>
                  <div class="slide-panel">
                    <img class="slide-img" src="img/img-slider/foto2.jpg" alt="">
                    <div class="slide-box">
                      <h2 class="slide-text">LOVER PELUCHES</h2>
                    </div>
                  </div>
                  <div class="slide-panel">
                    <img class="slide-img" src="img/img-slider/foto3.jpg" alt="">
                    <div class="slide-box">
                      <h2 class="slide-text">escuchamos tus consultas</h2>
                    </div>
                  </div>
                  <div class="slide-panel">
                    <img class="slide-img" src="img/img-slider/foto4.jpg" alt="">
                    <div class="slide-box">
                      <h2 class="slide-text">Gracias por visitarnos.</h2>
                    </div>
                  </div>
                </div>
    ...
    <footer>
      <div class="footer" id="footer">
          <ul class="redes">
            ...
            <li>
              <a href="php/form.php" title="Contacto"><img src="img/gmail.png" alt=""></a>
            </li>
          </ul>
